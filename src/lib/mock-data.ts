...
export const assignments: Assignment[] = [
  ...
  },
  {
    ...
    course: 'BIOL 101',
    dueDate_DO_NOT_USE: new Date(new Date().setDate(new Date().getDate() - 1)),
    submitted: true,
...
export const announcements: Announcement[] = [
  {
    ...
    content:
      'The midterm exam will now be held in room 304 of the engineering building.',
  },
  {
    id: '2',
    ...
    content:
      'Dr. Eleanor Vance will be giving a lecture on the Flavian dynasty.',
  },
];
